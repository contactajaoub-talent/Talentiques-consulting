...
export const content = {
  ...
  resources: {
    ...
    paid: [
      {
        title: 'Kit CV ATS',
        description: 'Modèles, guide, exemples et checklist.',
        status: 'À venir',
      },
      {
        title: 'Kit LinkedIn',
        description: 'Structure, méthodes et exemples pratiques.',
        status: 'À venir',
      },
      {
        title: "Kit Recherche d’emploi",
        description:
          'Organisation, relances et préparation des candidatures.',
        status: 'À venir',
      },
      {
