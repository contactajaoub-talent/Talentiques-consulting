...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/affiliation`, changeFrequency: 'monthly', priority: .8 },
    { url: `${base}/en/affiliate`, changeFrequency: 'monthly', priority: .8 },
    { url: `${base}/affiliation/conditions`, changeFrequency: 'yearly', priority: .3 },
    { url: `${base}/en/affiliate/terms`, changeFrequency: 'yearly', priority: .3 },
