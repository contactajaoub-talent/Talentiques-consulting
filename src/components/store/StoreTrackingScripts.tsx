...
export default function StoreTrackingScripts() {
  ...
  return (
    <>
      {metaPixelId && (
        <Script id="talentiques-store-meta-pixel" strategy="afterInteractive">
          {`
      ...
      {clarityId && (
        <Script id="talentiques-store-clarity" strategy="afterInteractive">
          {`
      ...
      {ga4Id && (
        <>
          ...
          />
          <Script id="talentiques-store-ga4" strategy="afterInteractive">
            {`
